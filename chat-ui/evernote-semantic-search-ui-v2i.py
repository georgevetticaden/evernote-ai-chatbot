...
st.markdown("<h1 style='text-align: center;'>Search your Evernotes using Semantic Search / Natural Language</h1>", unsafe_allow_html=True)
...
stack_name = st.sidebar.radio("Choose a Stack:", ("Home", "Work"))
